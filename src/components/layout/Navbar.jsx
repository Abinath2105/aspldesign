...
//   const services = [
//     { name: 'Business', color: '#6366F1', items: ['Web & Apps', 'Marketing', 'UI/UX', 'Compliance', 'Staffing', 'Print'] },
//     { name: 'Hospitality', color: '#F59E0B', items: ['Dining', 'Corporate', 'Weddings', 'Management'] },
//     { name: 'Technology', color: '#10B981', items: ['Refurbished', 'Enterprise', 'Support', 'Education'] },
//     { name: 'Training', color: '#0EA5E9', items: ['Marketing', 'Development', 'Design', 'Soft Skills'] },
//     { name: 'Creative', color: '#EC4899', items: ['Studio', 'Production', 'Editing', 'Partnership'] },
//   ];
...
//     closeTimeout.current = setTimeout(() => setShowServices(false), 200);
//   };
...
//           {/* Logo */}
//           <a href="#" className="nav-logo" aria-label="ASPL Home">
//             <img src={logo} alt="ASPL" className="nav-logo-img" />
//           </a>
...
//             >
//               <button 
//                 className={`nav-dd-trigger ${showServices ? 'is-open' : ''}`}
//                 onClick={() => setShowServices(!showServices)}
//               >
//                 <span>Services</span>
//                 <ChevronDown size={14} strokeWidth={2} className={`nav-dd-chevron ${showServices ? 'is-rotated' : ''}`} />
//               </button>

//               <div className={`nav-menu ${showServices ? 'is-open' : ''}`}>
...
//                       >
//                         <h4 className="nav-menu-name">{s.name}</h4>
//                         <div className="nav-menu-tags">
//                           {s.items.slice(0, 4).map((item, j) => (
//                             <span key={j} className="nav-menu-tag">{item}</span>
//                           ))}
//                         </div>
//                       </a>
//                     ))}
...
//                     <a href="#services" className="nav-menu-all" onClick={() => setShowServices(false)}>
//                       View all services
...
//             <a href="tel:9843406360" className="nav-icon-btn" aria-label="Call">
//               <Phone size={16} strokeWidth={1.8} />
//             </a>
//             <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="nav-icon-btn nav-icon-btn--wa" aria-label="WhatsApp">
//               <MessageCircle size={16} strokeWidth={1.8} />
//             </a>
...
//             >
//               <span className="nav-burger-line nav-burger-line--top" />
//               <span className="nav-burger-line nav-burger-line--bottom" />
//             </button>
//           </div>
//         </div>
//       </header>
...
//                   key={i}
//                   href="#services"
//                   className="nav-mobile-service"
//                   onClick={() => setIsOpen(false)}
//                   style={{ '--color': s.color, animationDelay: `${i * 0.05}s` }}
//                 >
//                   <span className="nav-mobile-service-dot" />
//                   {s.name}
//                   <span className="nav-mobile-service-count">{s.items.length}</span>
//                 </a>
//               ))}
//             </div>
//           </div>
...
//           {/* Mobile Links */}
//           <div className="nav-mobile-section">
//             <span className="nav-mobile-label">Navigate</span>
//             {navLinks.map((link, i) => (
//               <a
//                 key={i}
//                 href={link.href}
...
//             <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="nav-mobile-contact-btn nav-mobile-contact-btn--wa">
//               <MessageCircle size={16} strokeWidth={1.8} />
//               <span>WhatsApp</span>
//             </a>
//             <a href="tel:9843406360" className="nav-mobile-contact-btn nav-mobile-contact-btn--call">
//               <Phone size={16} strokeWidth={1.8} />
//               <span>Call us</span>
//             </a>
//           </div>
